...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('sites/title.list_page')
            <small>- @lang('sites/title.page_desc')</small>
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">@lang('sites/title.list_page')
            </li>
        </ol>
    </section>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left">
                        <i class="livicon" data-name="list" data-size="16" data-loop="true" data-c="#fff"
                           data-hc="white"></i>
                        @lang('sites/title.list')
                    </h4>

                    <div class="pull-right">
                        <a href="{{ route('admin.sites.create') }}" class="btn btn-sm btn-default"><span
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="table1">
                        <thead>
                        <tr class="filters">
                            <th>@lang('sites/title.code')</th>
                            <th>@lang('sites/title.name')</th>
                            <th>@lang('sites/title.gps_lat')</th>
                            <th>@lang('sites/title.gps_long')</th>
