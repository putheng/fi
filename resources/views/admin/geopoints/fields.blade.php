<div class="form-group {{ $errors->first('name', 'has-error') }}">
    {!! Form::label('code', Lang::get('geopoints/title.code'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-3">
...
<div class="form-group {{ $errors->first('name', 'has-error') }}">
    {!! Form::label('name', Lang::get('geopoints/title.name_lang1'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-3">
...
<div class="form-group {{ $errors->first('name_lang2', 'has-error') }}">
    {!! Form::label('name_lang2', Lang::get('geopoints/title.name_lang2'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-3">
...
<div class="form-group {{ $errors->first('gps_lat', 'has-error') }}">
    {!! Form::label('gps_lat', Lang::get('geopoints/title.gps_lat'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-3">
...
<div class="form-group {{ $errors->first('gps_long', 'has-error') }}">
    {!! Form::label('gps_long', Lang::get('geopoints/title.gps_long'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-3">
...
<div class="form-group {{ $errors->first('sort_index', 'has-error') }}">
    {!! Form::label('sort_index', Lang::get('geopoints/title.sort_index'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-3">
...
<div class="form-group">
    <div class="col-md-offset-2 col-md-10">
        ...
        <a href="{!! route('admin.geopoints.index') !!}" class="btn btn-default"
