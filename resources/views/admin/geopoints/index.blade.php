...
{{-- Page title --}}
@section('title')
    @lang('geopoints/title.list_page')
    @parent
@stop
...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('geopoints/title.list_page')
            <small>- @lang('geopoints/title.page_desc')</small>
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">@lang('geopoints/title.list_page')
            </li>
        </ol>
    </section>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left">
                        <i class="livicon" data-name="list" data-size="16" data-loop="true" data-c="#fff"
                           data-hc="white"></i>
                        @lang('geopoints/title.list')
                    </h4>

                    <div class="pull-right">
                        <a href="{{ route('admin.geopoints.create') }}" class="btn btn-sm btn-default"><span
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="table1">
                        <thead>
                        <tr class="filters">
                            <th>@lang('geopoints/title.code')</th>
                            <th>@lang('geopoints/title.name')</th>
                            <th>@lang('geopoints/title.gps_lat')</th>
                            <th>@lang('geopoints/title.gps_long')</th>
    ...
    <script>
        $(function () {
            var table = $('#table1').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{!! route('admin.geopoints.data') !!}",
                    "type": "POST",
                    "headers": {
