...
<form action="{{ route('admin.question.info.create') }}" method="post" class="form-horizontal">
    {{ csrf_field() }}
    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
        <label for="title" class="col-md-2 control-label">Title KH</label>
        <div class="col-md-4">
            <input class="form-control font-sr" value="{{ old('title') }}" name="title" type="text" id="title">
            @if($errors->has('title'))
    ...
    <div class="form-group {{ $errors->has('title_en') ? ' has-error' : '' }}">
        ...
        <div class="col-md-4">
            <input class="form-control font-sr" value="{{ old('title_en') }}" name="title_en" type="text" id="title_en">
